package utt.cntt.httt.manager.Service;
...
import utt.cntt.httt.manager.activity.MainActivity;
...
public class FirebaseMessagerReceiver extends FirebaseMessagingService {
    ...
    private RemoteViews customView(String title, String body) {
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_launcher_foreground);
        return remoteViews;
    }
}
